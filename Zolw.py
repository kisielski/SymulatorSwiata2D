...
class Zolw(Zwierze):
	...
	def __init__(self, x, y, swiat):
		...
		self._Organizm__sila = 2
		self._Organizm__inicjatywa = 1
		self._Organizm__typ = 'Z'
		self._Organizm__swiat = swiat
		self._Organizm__img = pygame.image.load(os.path.join("assets", "zolw.png"))
		swiat.dodajOrganizm(x, y, self)

	def akcja(self, com):
		szansa = random.randint(1, 4)
		if szansa != 4:
	...
	def porod(self, x, y):
		self._Organizm__swiat.dodajOrganizm(x, y, Zolw(x, y, self._Organizm__swiat))